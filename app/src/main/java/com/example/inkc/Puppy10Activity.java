...
public class Puppy10Activity extends AppCompatActivity {
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		setContentView(R.layout.puppy10);
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		calendarview1.setOnDateChangeListener(new CalendarView.OnDateChangeListener() {
			...
			public void onSelectedDayChange(CalendarView _param1, int _param2, int _param3, int _param4) {
				...
				edittext24.setText(new SimpleDateFormat("dd/MM/yyy").format(calendar.getTime()));
			}
		});
